...
public class General {
	...
	public void registrarEmpresaOK(){
		...
		assertEquals(Resultado.OK,s.registrarEmpresa("Anaconda", "", "", "email@email.com", "red").resultado);
		assertEquals(Resultado.OK,s.registrarEmpresa("Morticia", "", "", "email@email.com", "red").resultado);
		assertEquals(Resultado.OK,s.registrarEmpresa("9Empresa", "", "", "email@email.com", "red").resultado);
		assertEquals(Resultado.OK,s.registrarEmpresa("JurassicPark", "", "", "email@email.com", "red").resultado);
		assertEquals(Resultado.OK,s.registrarEmpresa("IberPark", "", "", "email@email.com", "red").resultado);
		assertEquals(Resultado.OK,s.registrarEmpresa("Kremlin", "", "", "email@email.com", "red").resultado);
		assertEquals(Resultado.OK,s.registrarEmpresa("ZbzzyPants", "", "", "email@email.com", "red").resultado);
		assertEquals(Resultado.OK,s.registrarEmpresa("Cthulhu", "", "", "email@email.com", "red").resultado);
	}
	...
	@Test
    public void registrarDCOK2(){
    	registrarCiudadOK();
    	assertEquals(Resultado.OK,s.registrarDC("A", 47.0, -122.0, "ZazzyPants", 90, 10).resultado);
    	...
    	assertEquals(Resultado.OK,s.registrarDC("G", -28.6, -22.1, "ClassyCat", 3200, 2).resultado);
    	assertEquals(Resultado.OK,s.registrarDC("H", -14.93, -42.9, "ClassyCat", 3200, 2).resultado);
    	assertEquals(Resultado.OK,s.registrarDC("I", -4.3, -56.9, "ZazzyPants", 2000, 2).resultado);
    }
	 
	public void registrarTramoOK2(){
    	registrarDCOK2();
    	...
    	assertEquals(Resultado.OK,s.registrarTramo(-20.90, -50.16, 47.606210, -122.332071, 300).resultado);//C--Seattle
    	
    	assertEquals(Resultado.OK,s.registrarTramo(-25.93, -100.11, 47.606210, -122.332071, 2).resultado);//F--Seattle
    	assertEquals(Resultado.OK,s.registrarTramo(-20.90, -50.16, -25.93, -100.11, 1).resultado);//C--Seattle
    	...
    	assertEquals(Resultado.OK,s.registrarTramo(-4.3, -56.9, -14.93, -42.9, 1).resultado);//I--H
    	assertEquals(Resultado.OK,s.registrarTramo(16.853109, -99.823653, -15.90, -55.16, 1).resultado);//acap--B
